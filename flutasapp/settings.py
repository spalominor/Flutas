"""
Django settings for flutasapp project.
...
WSGI_APPLICATION = 'flutasapp.wsgi.application'
...
# Configuración de COMPRESSOR para la compresión de archivos estáticos Tailwind
